...
// Source: github.com/ozoncp/ocp-presentation-api/internal/flusher/presentation (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 []model.Presentation) ([]model.Presentation, error) {
	m.ctrl.T.Helper()
