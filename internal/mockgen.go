...
//go:generate mockgen -destination=./ocp-slide-api/mock/saver_mock.go -package=mock github.com/ozoncp/ocp-presentation-api/internal/ocp-slide-api/saver Saver
